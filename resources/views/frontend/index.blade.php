...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --circle-orange-light: rgba(255, 165, 0, 0.2);
        ...
        .circles li:nth-child(3n+1) {
            background: var(--circle-blue-light);
        }

        .circles li:nth-child(3n+2) {
            background: var(--circle-green-light);
        }

        .circles li:nth-child(3n) {
            background: var(--circle-orange-light);
        }

        body.dark-mode .circles li:nth-child(3n+1) {
            background: var(--circle-blue-dark);
        }

        body.dark-mode .circles li:nth-child(3n+2) {
            background: var(--circle-green-dark);
        }

        body.dark-mode .circles li:nth-child(3n) {
            background: var(--circle-orange-dark);
        }
        ...
        .portal-icon.text-primary {
            background: var(--bg-primary-light);
        }

        .portal-icon.text-success {
            background: var(--bg-success-light);
        }

        .portal-icon.text-danger {
            background: var(--bg-danger-light);
        }

        .portal-icon.text-purple {
        ...
        body.dark-mode .portal-icon.text-primary {
            background: var(--bg-primary-dark);
        }

        body.dark-mode .portal-icon.text-success {
            background: var(--bg-success-dark);
        }

        body.dark-mode .portal-icon.text-danger {
            background: var(--bg-danger-dark);
        }

        body.dark-mode .portal-icon.text-purple {
        ...
        .login-btn.btn-purple {
            ...
            color: #9c4fd9 !important;
            /* Force text color for HR button */
        }
        ...
        body.dark-mode .login-btn.btn-primary {
            background: var(--bg-primary-dark);
        }

        body.dark-mode .login-btn.btn-success {
            background: var(--bg-success-dark);
        }

        body.dark-mode .login-btn.btn-danger {
            background: var(--bg-danger-dark);
        }

        body.dark-mode .login-btn.btn-purple {
            background: var(--bg-purple-dark);
        }

        body.dark-mode .login-btn.btn-warning {
            background: var(--bg-warning-dark);
        }

...
@section('icon', 'bi bi-folder2-open fs-4 p-2 bg-primary bg-opacity-10 rounded-3 text-primary')
...
<style>
    ...
    .stat-block {
        text-align: left;
        margin-bottom: 16px; /* Spacing for mobile wrapping */
    }
    ...
    .bg-light-blue { background-color: var(--soft-blue); color: var(--text-blue); }
    .bg-light-green { background-color: var(--soft-green); color: var(--text-green); }
    .bg-light-orange { background-color: var(--soft-orange); color: var(--text-orange); }
    .bg-light-red { background-color: var(--soft-red); color: var(--text-red); }
    ...
    .header-blue { background-color: #dbeafe; color: #2563eb; }
    .header-red { background-color: #fee2e2; color: #dc2626; }

    [data-theme="dark"] .header-blue { background-color: rgba(37, 99, 235, 0.2); }
    [data-theme="dark"] .header-red { background-color: rgba(220, 38, 38, 0.2); }
    ...
    @media (max-width: 768px) {
        ...
        .stat-block {
            margin-bottom: 20px; /* More space between rows in 2x2 grid */
        }
        .cat-card {
            padding: 16px;
        }
...
<div class="content-body">
    ...
    <div class="card-custom border-0 bg-transparent p-0 mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div class="d-flex gap-2 flex-wrap search-filters">
            ...
            <small class="text-primary fw-bold ms-auto ms-md-0">5 resources found</small>
        </div>
    </div>
    ...
    <div class="row g-3 g-md-4 mb-5">
        <div class="col-6 col-md">
            <div class="cat-card">
                ...
                <small class="text-primary fw-bold mt-1">45</small>
            </div>
        </div>
        <div class="col-6 col-md">
            <div class="cat-card">
                ...
                <small class="text-primary fw-bold mt-1">28</small>
            </div>
        </div>
        <div class="col-6 col-md">
            <div class="cat-card">
                <div class="cat-icon-box bg-light-orange"><i class="bi bi-pencil-square"></i></div>
                <h6 class="fw-bold text-main m-0" style="font-size: 0.9rem;">Practice</h6>
                <small class="text-primary fw-bold mt-1">35</small>
            </div>
        </div>
        <div class="col-6 col-md">
            <div class="cat-card">
                <div class="cat-icon-box bg-light-blue"><i class="bi bi-folder"></i></div>
                <h6 class="fw-bold text-main m-0" style="font-size: 0.9rem;">Templates</h6>
                <small class="text-primary fw-bold mt-1">18</small>
            </div>
        </div>
        <div class="col-6 col-md">
            <div class="cat-card">
                <div class="cat-icon-box bg-light-red"><i class="bi bi-play-btn"></i></div>
                <h6 class="fw-bold text-main m-0" style="font-size: 0.9rem;">Videos</h6>
                <small class="text-primary fw-bold mt-1">52</small>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="resource-card">
                ...
                <div class="resource-body">
                    <h6 class="fw-bold text-main mb-2">JavaScript ES6+ Features</h6>
                    ...
                    <button class="download-btn mt-auto">Open Link</button>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="resource-card">
                ...
                <div class="resource-body">
                    ...
                    <button class="download-btn mt-auto">Download</button>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-md-6 col-lg-4">
            <div class="resource-card">
                ...
                <div class="resource-body">
                    <h6 class="fw-bold text-main mb-2">ML Algorithms Cheat Sheet</h6>
                    <p class="small mb-3" style="color: var(--text-muted)">Quick reference guide for popular ML
                        algorithms with snippets.</p>

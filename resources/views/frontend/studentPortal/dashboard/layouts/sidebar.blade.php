<aside class="sidebar d-flex flex-column no-scrollbar" id="sidebar">
        ...
        <nav class="nav flex-column gap-1">
            ...
            <div class="collapse {{ $isProfileActive ? 'show' : '' }} ps-3 mb-1" id="profileSubmenu">
                <a href="{{ route('student.profile.personal') }}"
                    ...
                    <span class="nav-label ms-3">Personal Info</span>
                </a> <a href="{{ route('student.profile.academic') }}"
    ...
    <span class="nav-label ms-3">Approved Drives</span>
            ...
            <a class="nav-link {{ $isCommActive ? 'text-primary' : '' }} d-flex align-items-center justify-content-between"
                href="#commSubmenu" data-bs-toggle="collapse" role="button"
            ...
            <div class="collapse {{ $isCommActive ? 'show' : '' }} ps-3 mb-1" id="commSubmenu">
                <a href="{{ route('student.communication.messages') }}"
                    class="nav-link small py-2 mb-1 rounded-2 {{ request()->routeIs('student.communication.messages') ? 'bg-soft-blue text-primary fw-bold' : '--text-muted' }} d-flex align-items-center">
                    <i class="bi bi-envelope"></i> <span class="nav-label ms-3">Messages</span>
                </a>
                <a href="{{ route('student.communication.announcements') }}"
                    class="nav-link small py-2 mb-1 rounded-2 {{ request()->routeIs('student.communication.announcements') ? 'bg-soft-blue text-primary fw-bold' : '--text-muted' }} d-flex align-items-center">
                    <i class="bi bi-megaphone"></i> <span class="nav-label ms-3">Announcements</span>
                </a>
                <a href="{{ route('student.communication.schedule') }}"
                    class="nav-link small py-2 mb-1 rounded-2 {{ request()->routeIs('student.communication.schedule') ? 'bg-soft-blue text-primary fw-bold' : '--text-muted' }} d-flex align-items-center">
            ...
            <a class="nav-link {{ $isPerfActive ? 'text-primary' : '' }} d-flex align-items-center justify-content-between"
                href="#perfSubmenu" data-bs-toggle="collapse" role="button"
                aria-expanded="{{ $isPerfActive ? 'true' : 'false' }}">
                <div class="d-flex align-items-center">
            ...
            <div class="collapse {{ $isPerfActive ? 'show' : '' }} ps-3 mb-1" id="perfSubmenu">
                <a href="{{ route('student.performance.analytics') }}"
                    class="nav-link small py-2 mb-1 rounded-2 {{ request()->routeIs('student.performance.analytics') ? 'bg-soft-blue text-primary fw-bold' : '--text-muted' }} d-flex align-items-center">
                    <i class="bi bi-graph-up"></i> <span class="nav-label ms-3">Analytics</span>
                </a>
                <a href="{{ route('student.performance.reports') }}"
                    class="nav-link small py-2 mb-1 rounded-2 {{ request()->routeIs('student.performance.reports') ? 'bg-soft-blue text-primary fw-bold' : '--text-muted' }} d-flex align-items-center">
                    <i class="bi bi-file-earmark-text"></i> <span class="nav-label ms-3">Reports</span>
                </a>
                <a href="{{ route('student.performance.feedback') }}"
                    class="nav-link small py-2 mb-1 rounded-2 {{ request()->routeIs('student.performance.feedback') ? 'bg-soft-blue text-primary fw-bold' : '--text-muted' }} d-flex align-items-center">
            ...
            <a class="nav-link {{ $isAchieveActive ? 'text-primary' : '' }} d-flex align-items-center justify-content-between"
                href="#achieveSubmenu" data-bs-toggle="collapse" role="button"
                aria-expanded="{{ $isAchieveActive ? 'true' : 'false' }}">
                <div class="d-flex align-items-center">
            ...
            <div class="collapse {{ $isAchieveActive ? 'show' : '' }} ps-3 mb-1" id="achieveSubmenu">
                <a href="{{ route('student.achievements.certificates') }}"
                    class="nav-link small py-2 mb-1 rounded-2 {{ request()->routeIs('student.achievements.certificates') ? 'bg-soft-blue text-primary fw-bold' : '--text-muted' }} d-flex align-items-center">
                    <i class="bi bi-award"></i> <span class="nav-label ms-3">Certificates</span>
                </a>
                <a href="{{ route('student.achievements.badges') }}"
                    class="nav-link small py-2 mb-1 rounded-2 {{ request()->routeIs('student.achievements.badges') ? 'bg-soft-blue text-primary fw-bold' : '--text-muted' }} d-flex align-items-center">
                    <i class="bi bi-patch-check"></i> <span class="nav-label ms-3">Badges</span>
                </a>
                <a href="{{ route('student.achievements.portfolio') }}"
                    class="nav-link small py-2 mb-1 rounded-2 {{ request()->routeIs('student.achievements.portfolio') ? 'bg-soft-blue text-primary fw-bold' : '--text-muted' }} d-flex align-items-center">
                    <i class="bi bi-briefcase"></i> <span class="nav-label ms-3">Portfolio</span>
                </a>
            </div>
    ...
    <div class="user-footer p-2 m-2">
        <div class="d-flex align-items-center gap-2 p-2 rounded bg-soft-light">
            ...
            <div class="user-info flex-grow-1" style="line-height: 1.2;">
                <div class="fw-bold small">{{ Auth::user()->full_name }}</div>

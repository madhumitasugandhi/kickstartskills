...
<style>
    ...
    .meta-item i { font-size: 1.1rem; color: var(--text-blue); margin-right: 8px; }
    .meta-label { font-size: 0.75rem; color: var(--text-muted); display: block; margin-bottom: 2px; }
    .meta-value { font-weight: 600; color: var(--text-main); font-size: 0.95rem; }
    .tech-pill {
    ...
    .phase-name { font-size: 1.1rem; font-weight: 700; color: var(--text-blue); }
    .progress-bar-custom { height: 8px; background-color: var(--border-color); border-radius: 4px; overflow: hidden; }
    .progress-fill { height: 100%; border-radius: 4px; background-color: var(--text-blue); }
    .stats-row { display: flex; justify-content: space-between; margin-bottom: 12px; font-size: 0.9rem; }
    .stats-dot { width: 8px; height: 8px; border-radius: 50%; display: inline-block; margin-right: 8px; }
    .dot-green { background-color: #198754; } .dot-blue { background-color: #0d6efd; } .dot-orange { background-color: #fd7e14; }
    .stats-val { font-weight: 700; }
    .stats-val.green { color: #198754; } .stats-val.blue { color: #0d6efd; } .stats-val.orange { color: #fd7e14; }

    /* 3. Timeline Styles */
    .timeline-container { position: relative; padding-left: 12px; }
    .timeline-container::before {
        content: ''; position: absolute; left: 19px; top: 10px; bottom: 30px;
        width: 2px; background-color: var(--border-color); z-index: 0;
    }
    .timeline-item { display: flex; gap: 16px; margin-bottom: 32px; position: relative; z-index: 1; }
    .tl-icon {
        width: 16px; height: 16px; border-radius: 50%; margin-top: 6px; border: 2px solid white; box-shadow: 0 0 0 2px white;
    }
    ...
    .tl-content h6 { font-weight: 600; color: var(--text-main); margin-bottom: 2px; font-size: 0.95rem; }
    .tl-content p { font-size: 0.85rem; color: var(--text-muted); margin-bottom: 6px; }
    .tl-meta { font-size: 0.75rem; color: #0d6efd; font-weight: 500; background: var(--soft-blue); padding: 2px 8px; border-radius: 4px; }
    .tl-meta.green { color: #198754; background: #d1e7dd; }

    /* 4. Recent Activity Styles */
    .activity-item {
        display: flex; gap: 16px; padding-bottom: 16px; margin-bottom: 16px; border-bottom: 1px solid var(--border-color);
    }
    ...
    .action-icon-box {
        width: 32px; height: 32px; background: rgba(255,255,255,0.6); border-radius: 6px;
    ...
    <div class="row g-4 mb-4">
        <div class="col-lg-8">
            <div class="card-custom h-100 mb-0">
                ...
                <small class="--text-muted"><i class="bi bi-check-square me-1 text-primary"></i> Tasks: 5/15 completed</small>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card-custom h-100 mb-0  border-0">
                ...
                <div class="stats-row"><span><i class="stats-dot dot-green"></i> Overall Progress</span> <span class="stats-val green">22%</span></div>
                <div class="stats-row"><span><i class="stats-dot dot-blue"></i> Tasks Completed</span> <span class="stats-val blue">13/39</span></div>
                <div class="stats-row"><span><i class="stats-dot dot-orange"></i> Current Streak</span> <span class="stats-val orange">5 days</span></div>
                <div class="stats-row"><span><i class="stats-dot dot-green"></i> Skills Acquired</span> <span class="stats-val green">6</span></div>
            </div>
        </div>
    </div>
            ...
            <div class="card-custom">
                ...
                <div class="activity-item">
                    ...
                    <div class="flex-grow-1">
                        <div class="d-flex justify-content-between"><span class="fw-bold text-main small">Completed User Auth Module</span><small class="--text-muted">3h ago</small></div>
                ...
                <div class="activity-item">
                    ...
                    <div class="flex-grow-1">
                        <div class="d-flex justify-content-between"><span class="fw-bold text-main small">Code Review Session</span><small class="--text-muted">8h ago</small></div>
                ...
                <div class="activity-item">
                    ...
                    <div class="flex-grow-1">
                        <div class="d-flex justify-content-between"><span class="fw-bold text-main small">Weekly Progress Meeting</span><small class="--text-muted">1d ago</small></div>
                ...
                <div class="activity-item mb-0">
                    ...
                    <div class="flex-grow-1">
                        <div class="d-flex justify-content-between"><span class="fw-bold text-main small">Mastered React Hooks</span><small class="--text-muted">2d ago</small></div>
        ...
        <div class="col-lg-4">
            ...
            <a href="#" class="action-card ac-blue">
                <div class="d-flex align-items-center">
                    ...
                    <div><span class="action-title">View Tasks</span><span class="action-sub">Check assignments</span></div>
                </div>
            ...
            <a href="#" class="action-card ac-green">
                <div class="d-flex align-items-center">
                    ...
                    <div><span class="action-title">Track Progress</span><span class="action-sub">View detailed stats</span></div>
                </div>
                <i class="bi bi-chevron-right small text-muted"></i>
            </a>
            ...
            <a href="#" class="action-card ac-blue">
                <div class="d-flex align-items-center">
                    ...
                    <div><span class="action-title">Contact Mentor</span><span class="action-sub">Schedule meeting</span></div>
                </div>
                <i class="bi bi-chevron-right small text-muted"></i>
            </a>
            ...
            <a href="#" class="action-card ac-orange">
                <div class="d-flex align-items-center">
                    ...
                    <div><span class="action-title">View Certificate</span><span class="action-sub">Download certificate</span></div>
                </div>
                <i class="bi bi-chevron-right small text-muted"></i>
            </a>
        </div>

...
<style>
    ...
    .badge-tag {
        ...
        font-weight: 600;
        margin-left: 8px;
        white-space: nowrap; /* Prevents tag breaking */
    }
</style>
    ...
    <div class="history-card">
        <div class="d-flex justify-content-between align-items-start mb-3">
            <div class="d-flex gap-3">
                <div class="exam-icon-box flex-shrink-0" style="width: 48px; height: 48px; border-radius: 10px; background: #e0f2fe; color: #0284c7; display:flex; align-items:center; justify-content:center; font-size: 1.2rem;">
                    <i class="bi bi-question-circle"></i>
                </div>
                <div>
                    <h6 class="fw-bold text-main m-0 text-break">Advanced Flutter Development Quiz</h6>
                    <div class="mt-1">
    ...
    <div class="history-card">
        <div class="d-flex justify-content-between align-items-start mb-3">
            <div class="d-flex gap-3">
                ...
                <div>
                    <h6 class="fw-bold text-main m-0 text-break">Calculus Midterm Examination</h6>
                    <div class="mt-1">

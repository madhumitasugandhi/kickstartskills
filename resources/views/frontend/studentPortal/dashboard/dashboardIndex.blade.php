...
@section('icon', 'bi bi bi-house-door fs-4 p-2 bg-primary bg-opacity-10 rounded-3 text-primary')
<div class="content-body">
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-6">
            ...
            <div class="task-card bg-soft-blue border-primary">
                <div class="text-primary mt-1"><i class="bi bi-hourglass-split"></i></div>
                <div>
                    <div class="fw-bold text-main">Project Milestone Review</div>
                    <small class="text-primary fw-bold" style="font-size: 0.75rem;">Project • Due: Nov 5</small>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-6">
            <div class="card-custom h-100">
                ...
                <div class="course-card bg-soft-blue border border-primary-subtle">
                    ...
                    <div class="d-flex align-items-center gap-3 text-muted-custom small" style="font-size: 0.75rem;">
                ...
                <div class="course-card bg-soft-orange border border-warning-subtle mb-0">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                        ...
                        <span class="badge bg-warning text-dark rounded-pill" style="font-size: 0.65rem;">Popular</span>
                    </div>
                    <div class="d-flex align-items-center gap-3 text-muted-custom small" style="font-size: 0.75rem;">
    ...
    <div class="card-custom">
        ...
        <div class="notification-item bg-soft-blue ">
            <div class="p-2 bg-soft-blue rounded-circle text-primary d-flex align-items-center justify-content-center"
            ...
            <div class="flex-grow-1 ">
                <div class="d-flex justify-content-between">
                    ...
                    <span class="text-primary small"><i class="bi bi-circle-fill" style="font-size: 6px;"></i></span>
                </div>
        ...
        <div class="notification-item bg-soft-green">
            <div class="p-2 bg-soft-green rounded-circle text-success d-flex align-items-center justify-content-center"
        ...
        <div class="notification-item bg-soft-orange">
            <div class="p-2 bg-soft-orange rounded-circle text-warning d-flex align-items-center justify-content-center"
        ...
        <div class="notification-item bg-soft-teal mb-0">
            <div class="p-2 bg-soft-teal rounded-circle text-info d-flex align-items-center justify-content-center"

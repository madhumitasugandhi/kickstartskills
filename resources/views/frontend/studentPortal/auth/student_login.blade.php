...
<head>
    ...
    <title>Student Portal - Login | KickStartSkills</title>
    ...
    <style>
        ...
        :root {
            /* LIGHT MODE */
            --bg-gradient: linear-gradient(135deg, #316adc 0%, #5331dc 100%);
            --text-main: #ffffff;
            ...
            --circle-color-2: rgba(255, 255, 255, 0.10);
        ...
        body {
            ...
            /* --- FIX STARTS HERE --- */
            /* Removed 'overflow: hidden' which was locking the scroll */
            overflow-x: hidden;
            /* Prevents horizontal scroll from animation */
            overflow-y: auto;
            /* Allows vertical scroll on mobile */
            padding-top: 2rem;
        ...
        .circles {
            position: fixed;
            /* Changed from absolute to fixed so they stay in bg on scroll */
            top: 0;
            left: 0;
            width: 100%;
            height: 100%;
...
<body id="app-body">
    ...
    <div class="login-container">
        ...
        <div class="d-flex flex-column align-items-center mb-4">
            ...
            <p class="text-muted-custom mb-0 fw-medium">Student Portal</p>
        </div>

        <div class="login-card">
            <div class="text-center mb-4">
                <h4 class="fw-bold mb-2">Welcome Back!</h4>
                <p class="text-muted-custom small">Continue your learning journey</p>
            </div>
            ...
            <form action="{{ route('student.login.submit') }}" method="POST">
                ...
                @if($errors->any())
                <div class="alert alert-danger bg-soft-red text-red border-0 py-2 small mb-3">
                    {{ $errors->first() }}
                </div>
                @endif
                <div class="mb-3">
                    <label for="email" class="form-label small ms-1 mb-1 fw-medium text-muted-custom">Email
                        address</label>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('forgot.password', ['portal' => 'student']) }}" class="small link-custom">
    Forgot password?
</a>                </div>

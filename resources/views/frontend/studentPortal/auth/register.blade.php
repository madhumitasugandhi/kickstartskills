...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --btn-bg: #2563eb; --btn-hover: #1d4ed8; --btn-text: #ffffff;
        ...
        .icon-box { width: 64px; height: 64px; background: #3b82f6; border-radius: 18px; display: flex; align-items: center; justify-content: center; font-size: 1.75rem; color: #fff; margin-bottom: 1rem; box-shadow: 0 8px 20px rgba(59, 130, 246, 0.4); }
        ...
        .step.active { background: #3b82f6; border-color: #3b82f6; color: white; box-shadow: 0 0 15px rgba(59, 130, 246, 0.5); transform: scale(1.1); }
        ...
        /* Buttons */
        .btn-action { background-color: var(--btn-bg); color: var(--btn-text); font-weight: 600; padding: 12px; border-radius: 10px; border: none; width: 100%; margin-top: 1rem; box-shadow: 0 4px 15px rgba(37, 99, 235, 0.3); transition: all 0.2s; }
...
<body>
    ...
    <a href="{{ url('/student-login') }}" class="nav-btn back-btn"><i class="fas fa-arrow-left"></i></a>
    ...
    <div class="auth-container">
        ...
        <form action="#" method="POST" id="main-register-form">
            <div id="step-1-form">
                @include('frontend.studentPortal.auth.registerLayouts.step1')
            </div>

            <div id="step-2-form" style="display: none;">
                @include('frontend.studentPortal.auth.registerLayouts.step2')
            </div>

            <div id="step-3-form" style="display: none;">
                @include('frontend.studentPortal.auth.registerLayouts.step3')
            </div>
        </form>

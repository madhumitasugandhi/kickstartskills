...
<head>
    ...
    <title>Admin Portal - Login | KickStartSkills</title>
    ...
    <style>
        /* ------------------ CUSTOM THEME CONFIGURATION (RED/ADMIN) ------------------ */
        :root {
            /* LIGHT MODE - Red Theme (Matches Reference Image) */
            /* Gradient from a bright crimson to a deep red */
            --bg-gradient: linear-gradient(135deg, #f83f3f 0%, #621515 100%);

            --text-main: #ffffff;
            --text-muted: rgba(255, 255, 255, 0.9);
            --card-bg: rgba(255, 255, 255, 0.15); /* Glass effect */
            ...
            /* Primary Button Color - Dark Red */
            --btn-bg: #991b1b;
            --btn-hover: #7f1d1d;
            --btn-text: #ffffff;

            /* Animation Circles - White/Red tints */
            --circle-color-1: rgba(255, 255, 255, 0.15);
            --circle-color-2: rgba(255, 255, 255, 0.1);
            --circle-color-3: rgba(255, 255, 255, 0.05);

            /* Alert Box Colors */
            --alert-bg: rgba(153, 27, 27, 0.2);
            --alert-border: rgba(153, 27, 27, 0.3);
            --alert-text: #fee2e2;
        }

        /* DARK MODE OVERRIDES */
        body.dark-mode {
            /* Very dark red/black gradient */
            --bg-gradient: linear-gradient(135deg, #450a0a 0%, #280505 100%);

            --text-main: #f5f5f5;
            --text-muted: #d6d3d1;
            --card-bg: rgba(69, 10, 10, 0.6); /* Dark Red Glass */
            ...
            --circle-color-1: rgba(239, 68, 68, 0.1);
            --circle-color-2: rgba(185, 28, 28, 0.05);
            --circle-color-3: rgba(255, 255, 255, 0.02);

            --alert-bg: rgba(0, 0, 0, 0.3);
            --alert-border: rgba(220, 38, 38, 0.3);
            --alert-text: #fca5a5;
        }
        ...
        /* Keeping original animation delays */
        ...
        /* ------------------ UI COMPONENT STYLES ------------------ */
        .login-container { width: 100%; max-width: 440px; padding: 15px; z-index: 10; }
        ...
        .logo-box {
            ...
            font-size: 1.8rem; color: #fff; margin-bottom: 1rem; backdrop-filter: blur(4px);
        }
        ...
        .custom-input:focus { outline: none; box-shadow: 0 0 0 3px rgba(220, 38, 38, 0.3); } /* Red focus ring */
        .custom-input:focus + .input-icon, .input-wrapper:focus-within .input-icon { color: #dc2626; }
...
<body id="app-body">
    ...
    <div class="login-container">
        <div class="d-flex flex-column align-items-center mb-4">
            ...
            <p class="text-muted-custom mb-0 fw-medium">Administration Portal</p>
        </div>

        <div class="login-card">
            <div class="text-center mb-4">
                <h4 class="fw-bold mb-2">Administrator Access</h4>
                <p class="text-muted-custom small">Manage the platform and oversee all operations</p>
            </div>

            <form>
                <div class="mb-3">
                    <label for="email" class="form-label small ms-1 mb-1 fw-medium text-muted-custom">Administrator email</label>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="/admin/forgot-password" class="small link-custom">Forgot password?</a>
                </div>
            ...
            <div class="security-alert">
                ...
                <div>
                    ...
                    Administrator access is logged and monitored for security purposes. Unauthorized access is prohibited.
                </div>
            </div>
        </div>
    </div>

<header class="top-header">
    ...
    <div class="d-flex align-items-center">
        <div class="me-3 d-none d-md-block ">
             <i class="bi @yield('icon', 'bi-speedometer2') fs-4 p-2 bg-soft-red rounded-3 text-red"></i>
        </div>
        <div>
            <h5 class="fw-bold m-0">@yield('title', 'Admin Dashboard')</h5>
    ...
    <div class="d-flex align-items-center gap-2 ms-auto">
        ...
        <a href="#" class="btn btn-light position-relative rounded-circle px-2"
    ...
    if (headerToggle) {
        headerToggle.addEventListener('click', function(e) {
            ...
            if (window.innerWidth >= 992) {
                ...
                // Force close dropdowns when minimizing

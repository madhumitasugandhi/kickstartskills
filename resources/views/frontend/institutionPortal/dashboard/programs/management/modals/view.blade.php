    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content glass-modal">
            ...
            <div class="modal-body px-4 pb-4">
                <div class="row g-3">
                    ...
                    <div class="col-12 mt-3">
                        <small class="text-muted d-block mb-2">Skills Offered</small>
                        <div class="d-flex flex-wrap gap-2">
                            <span class="chip-item">HTML / CSS</span>
                            <span class="chip-item">JavaScript</span>
                            <span class="chip-item">React</span>
                            <span class="chip-item">Node.js</span>
                            <span class="chip-item">Database</span>
                        </div>
                    </div>
            ...
            <div class="modal-footer border-0 px-4 pb-4">
                <button class="btn btn-teal px-4" data-bs-dismiss="modal">
                    Close
                </button>
            </div>

<div class="glass-card">
    ...
    <form onsubmit="verifyOtp(event)">
            ...
            <div class="input-group-custom">
                ...
                <input type="text" id="otp" class="custom-input" placeholder="123456" maxlength="6" style="letter-spacing: 4px; font-weight: 700;" required>
            </div>
        </div>
    ...
    <div class="mt-2">
    <a href="#" onclick="sendOtp(event)" class="link-back">
    Didn't receive code? <span id="resendText">Resend</span>
</a>
    </div>
</div>

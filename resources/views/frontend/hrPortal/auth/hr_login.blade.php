...
<head>
    ...
    <title>HR Portal - Login | KickStartSkills</title>
...
<body id="app-body">
    ...
    <div class="login-container">
        <div class="d-flex flex-column align-items-center mb-4">
            ...
            <p class="text-muted-custom mb-0 fw-medium">HR & Employee Portal</p>
        </div>

        <div class="login-card">
            <div class="text-center mb-4">
                <h4 class="fw-bold mb-2">Welcome, HR Team</h4>
            ...
            <div class="text-center mt-4">
                <p class="small text-muted-custom mb-0">
                    New company?
                    <a href="/hr/register" class="link-custom ms-1">Register Company</a>
                </p>
            </div>
        </div>
    </div>

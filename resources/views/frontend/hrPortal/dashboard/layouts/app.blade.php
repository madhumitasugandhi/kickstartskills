...
<head>
    ...
    <style>
        ...
        [data-theme="dark"] {
            ...
            /* ACCENT COLORS (HR PURPLE THEME) */
            --accent-color: #7c3aed; /* Keep vibrant purple */
            --soft-accent: rgba(124, 58, 237, 0.15); /* Transparent Purple */
        ...
        /* btn-outline-primary custom (Purple) */
        .btn-outline-primary {
        ...
        .sub-link.active i { color: var(--accent-color) !important; opacity: 1; }
...
<body>
    ...
    @include('frontend.hrPortal.dashboard.layouts.sidebar')

    <main class="main-content">
        @include('frontend.hrPortal.dashboard.layouts.header')

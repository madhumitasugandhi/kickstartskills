...
@section('icon', 'bi bi-briefcase-fill fs-4 p-2 bg-soft-orange rounded-3 text-accent')
...
<style>
    ...
    .stat-card-pipeline {
        ...
        border-radius: 12px;
        padding: 20px; /* Reduced slightly for mobile fit */
        text-align: center;
    ...
    .modal-header-custom { border-bottom: 1px solid var(--border-color); padding: 20px 24px; }
    .modal-body-custom { padding: 24px; color: var(--text-main); }
    .section-label { color: var(--accent-color); font-weight: 700; font-size: 0.85rem; margin-bottom: 8px; display: block; }
    .info-list { list-style: none; padding: 0; margin: 0; }
    .info-list li { margin-bottom: 8px; font-size: 0.9rem; color: var(--text-muted); display: flex; align-items: center; gap: 10px; }
    ...
    @media (min-width: 768px) {
        .search-input { min-width: 250px; width: auto; }
        .filter-select { min-width: 150px; width: auto; }
    }
</style>

<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3 filter-container border-0 p-0 bg-transparent">
    <h5 class="fw-bold m-0 text-main">Recruitment Pipeline</h5>
    <div class="d-flex align-items-center gap-3">
        <span class="badge bg-soft-purple-custom text-accent px-3 py-2 rounded-pill border border-light border-opacity-10 w-100 w-md-auto text-center">5 Total Applications</span>
    </div>
</div>

<div class="row g-3 mb-4 row-cols-2 row-cols-md-3 row-cols-xl-5 justify-content-center">
    <div class="col"><div class="stat-card-pipeline stat-blue"><h3 class="fw-bold mb-0 text-main">0</h3><span class="--text-muted-custom small mt-1">Applied</span></div></div>
    <div class="col"><div class="stat-card-pipeline stat-purple"><h3 class="fw-bold mb-0 text-main">1</h3><span class="--text-muted-custom small mt-1">Screening</span></div></div>
    <div class="col"><div class="stat-card-pipeline stat-orange"><h3 class="fw-bold mb-0 text-main">3</h3><span class="--text-muted-custom small mt-1">Interview</span></div></div>
    <div class="col"><div class="stat-card-pipeline stat-green"><h3 class="fw-bold mb-0 text-main">1</h3><span class="--text-muted-custom small mt-1">Offer</span></div></div>
    <div class="col"><div class="stat-card-pipeline stat-teal"><h3 class="fw-bold mb-0 text-main">0</h3><span class="--text-muted-custom small mt-1">Hired</span></div></div>
</div>

<div class="filter-container mb-4 d-flex flex-column flex-md-row gap-3 align-items-stretch align-items-md-center">
    <div class="d-flex align-items-center flex-grow-1 gap-2 position-relative">
        <i class="bi bi-search text-muted-custom fs-5 position-absolute ps-3"></i>
        <input type="text" class="search-input ps-5" placeholder="Search candidates...">
    </div>
        ...
        <div class="row align-items-center g-3 text-center text-lg-start">
            ...
            <div class="col-12 col-lg-2">
                <div class="d-flex flex-column align-items-center align-items-lg-end gap-2">
                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-lg-end gap-1 mb-2">
                        <i class="bi bi-star-fill rating-star"></i><span class="text-main small fw-bold">4.2</span>
                    </div>
                    <div class="d-flex gap-2 justify-content-center justify-content-lg-end w-100">
        ...
        <div class="row align-items-center g-3 text-center text-lg-start">
            ...
            <div class="col-12 col-lg-2">
                <div class="d-flex flex-column align-items-center align-items-lg-end gap-2">
                    ...
                    <div class="d-flex align-items-center justify-content-center justify-content-lg-end gap-1 mb-2"><i class="bi bi-star-fill rating-star"></i><span class="text-main small fw-bold">4.5</span></div>
                    <div class="d-flex gap-2 justify-content-center justify-content-lg-end w-100">
                        <button class="action-icon text-success"><i class="bi bi-arrow-right"></i></button>
                        <button class="action-icon text-primary"><i class="bi bi-file-earmark-text"></i></button>
                        <button class="action-icon"><i class="bi bi-three-dots-vertical"></i></button>
...
<div class="modal fade" id="candidateModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg"> <div class="modal-content-custom">
            ...
            <div class="modal-body-custom">
                <div class="row mb-4 g-4"> <div class="col-md-6">
                ...
                <div class="mt-2">
                    ...
                    <div class="row g-2">
                        <div class="col-12 col-sm-6"> <button class="btn-action-primary">

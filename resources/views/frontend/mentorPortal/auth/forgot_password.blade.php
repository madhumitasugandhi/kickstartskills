...
<body id="app-body">
    ...
    otpInputs.on('input', function() {
        if ($(this).val() && $(this).next().length) $(this).next().focus();
    ...
    otpInputs.on('keydown', function(e) {
        if (e.key === 'Backspace' && !$(this).val() && $(this).prev().length) $(this).prev().focus();
    });
    ...
    $('#otp-verify-form').on('submit', function(e) {
        ...
        if(otpVal.length < 6) { alert("Please enter the full 6-digit code."); return; }

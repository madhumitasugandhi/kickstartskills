...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --btn-bg: #e63900;
            /* Slightly darker than ff4500 for better contrast on white */
            --btn-hover: #cc3300;
            --btn-text: #ffffff;
...
<body id="app-body">
    ...
    <div class="login-container">
        ...
        <div class="login-card">
            ...
            <form action="{{ route('mentor.login.submit') }}" method="POST">
                @csrf @if($errors->any())
                <div class="alert alert-danger bg-soft-danger text-danger border-0 small p-2 mb-3">
                    <i class="bi bi-exclamation-triangle-fill me-2"></i> {{ $errors->first() }}
                </div>
                @endif
                <div class="mb-3">
                    <label for="email" class="form-label small ms-1 mb-1 fw-medium text-muted-custom">Mentor email
                        address</label>
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('forgot.password', ['portal' => 'mentor']) }}" class="small link-custom">
    Forgot password?
</a>                      </div>

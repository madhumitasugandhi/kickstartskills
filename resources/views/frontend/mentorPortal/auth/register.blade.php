...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --btn-bg: #e65100; /* Darker orange for buttons to stand out on the gradient */
            --btn-hover: #bf360c;
            --btn-text: #ffffff;

            --review-bg: rgba(0, 0, 0, 0.1);
...
<body>
    ...
    <a href="{{ url('/mentor-login') }}" class="nav-btn back-btn"><i class="fas fa-arrow-left"></i></a>

    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card-custom text-center py-4 mb-0 h-100 position-relative overflow-hidden">
                ...
                <div class="mb-3">
                    <i class="bi bi-activity fs-3 text-accent"></i> </div>
    ...
    <div class="row g-4 mb-4">
        <div class="col-lg-8">
            <div class="card-custom h-100 mb-0">
                ...
                <div class="bg-soft-blue rounded-3 d-flex align-items-end justify-content-between px-4 pb-0 pt-5 position-relative" style="height: 300px; overflow: hidden;">
                    <div class="position-absolute w-100 h-100 start-0 top-0 d-flex flex-column justify-content-between text-muted-custom small p-3" style="opacity: 0.3; z-index: 0;">
                    ...
                    <svg class="position-absolute start-0 top-0 w-100 h-100 p-3" style="z-index: 1;">
                        <polyline points="0,200 150,190 300,180 450,175 600,170 800,160"
                                  fill="none" stroke="var(--text-blue)" stroke-width="3" />
                    ...
                    <div class="w-100 d-flex justify-content-between position-relative" style="z-index: 2; margin-bottom: -2px;">
            ...
            <div class="card-custom h-100 mb-0">
                ...
                <div class="d-flex flex-column gap-4">
                    ...
                    <div>
                        ...
                        <div class="progress" style="height: 8px; background-color: var(--bg-hover);">
                            <div class="progress-bar bg-soft-orange" role="progressbar" style="width: 82%; background-color: var(--accent-color) !important;"></div>
                        </div>
                    </div>
            ...
            <div class="card-custom h-100 mb-0">
                ...
                <div class="d-flex align-items-center justify-content-center h-100" style="min-height: 200px;">
                    <div class="rounded-circle position-relative d-flex align-items-center justify-content-center"
                        ...
                        <div class="bg-card rounded-circle" style="width: 100px; height: 100px; position: absolute; background-color: var(--bg-card);"></div>
                    </div>
                </div>
                ...
                <div class="mt-2">
                    <div class="d-flex justify-content-between small mb-2">
                        <div class="d-flex align-items-center gap-2">
                            <span class="d-inline-block rounded-circle" style="width: 8px; height: 8px; background-color: var(--text-blue);"></span>
                    ...
                    <div class="d-flex justify-content-between small mb-2">
                        <div class="d-flex align-items-center gap-2">
                            <span class="d-inline-block rounded-circle" style="width: 8px; height: 8px; background-color: var(--accent-color);"></span>
                    ...
                    <div class="d-flex justify-content-between small mb-2">
                        <div class="d-flex align-items-center gap-2">
                            <span class="d-inline-block rounded-circle" style="width: 8px; height: 8px; background-color: var(--text-teal);"></span>
                    ...
                    <div class="d-flex justify-content-between small">
                        <div class="d-flex align-items-center gap-2">
                            <span class="d-inline-block rounded-circle mb-4" style="width: 8px; height: 8px; background-color: #20c997;"></span>

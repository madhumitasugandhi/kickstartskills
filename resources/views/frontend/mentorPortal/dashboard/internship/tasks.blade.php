...
<div class="card-custom mb-4">
    <div class="d-flex justify-content-between align-items-center">
        ...
        <button class="btn btn-primary fw-bold" style="background-color: var(--text-blue); border: none;">
...
<div class="row g-3 mb-4">
    <div class="col">
        <div class="card-custom text-center py-4 mb-0 h-100 bg-transparent">
            <div class="mb-2">
...
<div class="card-custom mb-3 border-start border-4 border-danger"
    style="border-left-color: var(--text-red) !important;">
    <div class="d-flex justify-content-between align-items-start mb-2">
        <div class="d-flex align-items-start gap-3">
            <div class="bg-soft-red p-2 rounded text-danger">
        ...
        <span class="badge bg-soft-red text-danger border border-danger-subtle rounded-pill px-3">Overdue</span>
    </div>
    ...
    <div class="row g-0 rounded-3 overflow-hidden border border-dark-subtle"
        ...
        <div class="col-4 border-end" style="border-color: var(--border-color) !important;">
            <button class="btn btn-link text-decoration-none w-100 text-muted-custom py-2" style="font-size: 0.85rem;">
        ...
        <div class="col-4">
            <button class="btn btn-primary w-100 py-2 rounded-0"
...
<div class="card-custom mb-3 border-start border-4 border-warning"
    style="border-left-color: var(--accent-color) !important;">
    <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center gap-3">
            <div class="bg-soft-orange p-2 rounded text-accent">
        ...
        <span class="badge bg-soft-orange text-accent border border-warning-subtle rounded-pill px-3">In Progress</span>
    </div>
</div>

        ...
        <div class="col-12 col-md-4">
            ...
            <div class="input-group">
                <span class="input-group-text border-end-0"
                    style="background-color: var(--bg-hover); border-color: var(--border-color); color: var(--text-muted);">
    ...
    <div class="col-xl-4">
        <div class="card-custom h-100 mb-0"
            ...
            <div class="d-flex flex-column gap-3">
                <div class="p-3 rounded-3 border border-dark-subtle"
                    ...
                    <div class="d-flex justify-content-between small mb-1">
                        ...
                        <span class="fw-bold " style="font-size: 0.7rem; color: var(--accent-color);">65%</span>
                    </div>
                    <div class="progress" style="height: 4px; background-color: rgba(255,255,255,0.1);">
                        <div class="progress-bar" style="width: 65%; background-color: var(--accent-color);"></div>
                    </div>
                </div>
            ...
            <div class="d-flex flex-column gap-3">
                ...
                <div class="p-3 rounded-3 border border-dark-subtle"
                    ...
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        <div class="d-flex gap-3">
                            ...
                            <div>
                                ...
                                <small class="text-muted-custom" style="font-size: 0.75rem;">Frontend Development -
                                    Batch 2024A</small>
                            </div>
                        </div>
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-6 col-md-3">
                            ...
                            <span class="fw-bold text-main h6"><i class="bi bi-graph-up me-1 text-primary"></i>
                                72%</span>
                        </div>
                        <div class="col-6 col-md-3">
                            <small class="text-muted-custom d-block" style="font-size: 0.7rem;">Tasks</small>
                            <span class="fw-bold text-main h6"><i class="bi bi-check2-square me-1 text-info"></i>
                                18/25</span>
                        </div>
                        <div class="col-6 col-md-3">
                            <small class="text-muted-custom d-block" style="font-size: 0.7rem;">Rating</small>
                            <span class="fw-bold text-main h6"><i class="bi bi-star me-1 text-accent"></i>
                                4.2/5.0</span>
                        </div>
                        <div class="col-6 col-md-3">
                            <small class="text-muted-custom d-block" style="font-size: 0.7rem;">Attendance</small>
                            <span class="fw-bold text-main h6"><i class="bi bi-calendar-check me-1 text-success"></i>
                                95%</span>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <span class="badge bg-soft-orange --text-accent-color  fw-normal"
                                style="border: 1px solid var(--accent-color)">E-commerce Dashboard</span>
                            <span class="badge bg-soft-orange --text-accent-color  fw-normal"
                                style="border: 1px solid var(--accent-color)">React Components Library</span>
                        </div>
                    </div>
                ...
                <div class="p-3 rounded-3 border border-dark-subtle"
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-6 col-md-3">
                            <small class="text-muted-custom d-block" style="font-size: 0.7rem;">Progress</small>
                            <span class="fw-bold text-main h6"><i class="bi bi-graph-up me-1 text-success"></i>
                                85%</span>
                        </div>
                        <div class="col-6 col-md-3">
                            <small class="text-muted-custom d-block" style="font-size: 0.7rem;">Tasks</small>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <span class="badge bg-soft-orange --text-accent-color  fw-normal"
                                style="border: 1px solid var(--accent-color)">Portfolio Website</span>
                        </div>
                    </div>

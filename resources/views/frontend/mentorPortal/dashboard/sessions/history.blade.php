...
@section('content')
    ...
    <div class="card-custom mb-4">
        <div class="d-flex align-items-center gap-3">
            <div class="bg-soft-blue p-3 rounded-3 text-primary" style="background-color: rgba(13, 110, 253, 0.1) !important;">
    ...
    <div class="card-custom mb-4">
        ...
        <div class="row g-3 align-items-end">
            ...
            <div class="col-md-3">
                ...
                <select class="form-select" style="background-color: var(--bg-hover); border-color: var(--border-color); color: var(--text-main);">
        ...
        <div class="d-flex justify-content-around mt-4 pt-3 border-top" style="border-color: var(--border-color) !important;">
    ...
    <div class="card-custom mb-4">
        ...
        <div class="mb-3">
            ...
            <div class="d-flex gap-2 flex-wrap">
                ...
                <span class="badge bg-bg-hover text-muted-custom border border-secondary fw-normal px-3 py-2">Components</span>
                <span class="badge bg-bg-hover text-muted-custom border border-secondary fw-normal px-3 py-2">Best Practices</span>
            </div>
        </div>

        <div class="p-3 rounded-3 mb-3 border border-dark-subtle" style="background-color: var(--bg-hover); border-color: var(--border-color) !important;">
            ...
            <p class="text-main mb-0 small" style="opacity: 0.9;">
                Great session! John made excellent progress on component structure. We discussed props drilling vs context API.
            </p>
        </div>
        ...
        <div class="row g-2">
            ...
            <div class="col-md-6">
                <button class="btn btn-outline-secondary w-100 fw-bold" style="border-color: var(--border-color); color: var(--text-muted);">

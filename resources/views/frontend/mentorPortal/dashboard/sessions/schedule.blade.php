    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            <div class="card-custom mb-4">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control border-start-0 ps-0"
                            placeholder="e.g. Weekly Sync with John"
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <span class="input-group-text border-end-0 d-flex align-items-start justify-content-center"
                            style="background-color: var(--bg-hover); border-color: var(--border-color); min-width: 45px;">
                            <i class="bi bi-file-text" style="color: var(--text-muted);"></i>
                        </span>
                        <textarea class="form-control border-start-0 ps-0" rows="3"
        ...
        <div class="col-lg-4">
            ...
            <div class="card-custom mb-4">
                ...
                <small class="text-danger mt-3 d-block" style="font-size: 0.75rem;">* Please select at least one
                    student</small>
            </div>

...
<div class="content-body" style="padding-bottom: 80px;">
    {{-- Form wrap kiya taaki save ho sake --}}
                ...
                <div class="card-custom">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="portfolio_website" class="form-control"
                    ...
                    <div class="mb-0">
                        ...
                        {{-- input-group se bahar nikal kar try karte hain agar spacing issue hai --}}
                        <select name="expertise_area" class="form-select profile-select-custom">
                            <option value="" selected disabled>Select Specialization</option>
                            @if(isset($categories) && $categories->count() > 0)
                            @foreach($categories as $cat)
                            <option value="{{ $cat->category_name }}" {{ ($profile->expertise_area ?? '') ==
                                $cat->category_name ? 'selected' : '' }}>
                                {{ $cat->category_name }}
                            </option>
                            @endforeach
                            @else
